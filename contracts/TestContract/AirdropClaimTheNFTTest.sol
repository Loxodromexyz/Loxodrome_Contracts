...
contract AirdropClaimLoxNFTTest is ReentrancyGuard {
    ...
    /// @notice claim the given amount and send to _to. Checks are done by merkle tree contract. (eg.: 40% veLox 60% $Lox)
